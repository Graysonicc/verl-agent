...
class ActorRolloutRefWorker(Worker):
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            with adapter_ctx:
                output, entropys, prada_prefix_embeddings = self.actor.compute_log_prob(data=data, calculate_entropy=True)
            output_tensors = {"old_log_probs": output, "entropys": entropys}
            if prada_prefix_embeddings is not None:
                output_tensors["prada_prefix_embeddings"] = prada_prefix_embeddings
